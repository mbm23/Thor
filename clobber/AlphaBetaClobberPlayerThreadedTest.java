...
public class AlphaBetaClobberPlayerThreadedTest extends BaseClobberPlayerTest implements Runnable {
	...
	{
		int depth = 4;
		GamePlayer p = new AlphaBetaClobberPlayerThreadedTest("Test " + depth, depth);
		p.compete(args, 1);
	}
	...
	public AlphaBetaClobberPlayerThreadedTest(String name, int d){
		super(name, false);
		depthLimit = d;
