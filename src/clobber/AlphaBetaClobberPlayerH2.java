...
public class AlphaBetaClobberPlayerH2 extends BaseClobberPlayerH2 {
	...
	public AlphaBetaClobberPlayerH2(String name, int d){
		super(name, false);
		depthLimit = d;
	...
	public AlphaBetaClobberPlayerH2(String n) 
	{
		super(n, false);
		for (int i =0; i < MAX_DEPTH; i++) {
	...
	*/
	...
	{
		int depth = 4;
		GamePlayer p = new AlphaBetaClobberPlayerH2("AlphaBetaH2" + depth, depth);
		p.compete(args, 1);
	}
}
